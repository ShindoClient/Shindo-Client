...
public enum TranslateText {
    ...
    JOIN_OUR_DISCORD_SERVER("text.joindiscordserver"), JOIN("text.join"), DISCORD_DESCRIPTION("text.discorddescription"), KILL_SOUNDS("text.killsounds.name"), KILL_SOUNDS_DESCRIPTION("text.killsounds.description"),
